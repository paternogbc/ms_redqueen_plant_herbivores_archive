...
library(sensiPhy)  # [github::paternogbc/sensiPhy] v0.8.5 # [github::paternogbc/sensiPhy] v0.8.5
...
gmale
ggsave(gmale, filename = "output/supp/supp_fig_histogram_flower_maleness.png", 
       width = 8.5, height = 7)
...
ggsave(gcor, filename = "output/supp/supp_fig_correlation_alternative_herbivore_predictors.png",
       width = 9, height = 8)
